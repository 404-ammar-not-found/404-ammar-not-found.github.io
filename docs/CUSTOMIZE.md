...
## Ammar Nagri setup sheet

Use this block as the source of truth while you finish the rest of the site.

### Personal information

| Field | Value |
| --- | --- |
| Full name | Ammar Nagri |
| Preferred display name | Ammar |
| Professional title | BSc Computer Science & Mathematics undergraduate |
| Short tagline | learning my machine |
| Profile photo | Upload later |
| Email address | ammar.nagri1@gmail.com |
| Location | London, GB |
| Pronouns | he/him |
...
I am Ammar Nagri, a BSc Computer Science and Mathematics undergraduate at The University of Manchester. My academic interests centre on theoretical machine learning, with a particular focus on diffusion models, neural networks, and the mathematical ideas that make them work.
...
- Research interests: machine learning, neural networks, diffusion models, theoretical ML
- Career goal: Research Engineer or Research Scientist
...
- End date: June 2028
- Grade/classification: Expected First Class with Honours

### Experience snapshot from the CV

- Software Engineer, Mubit-AI, London, GB, July 2026 to September 2026
- Machine Learning Intern, Level2, New York, NY (Remote), January 2026 to April 2026
- Software Engineer, JustEat Takeaway, London, GB, August 2022
- Project Leader, Manchester AI Society, The University of Manchester, September 2025 to present

### Awards snapshot

- International Olympiad of AI, Silver, April 2025
- UKMT Junior, Intermediate, and Senior Mathematics Challenges, multiple Gold Awards

### Skills snapshot

- Programming languages: Python, Java, PostgreSQL, MySQL, Golang, R, TypeScript, C++, JavaScript, LaTeX
- Frameworks and tooling: PyTorch, TensorFlow, FastAPI, Pydantic, Docker, Git, Weights & Biases, AWS, pytest, pprof
- Libraries: NumPy, Pandas, matplotlib, scikit-learn, OpenCV, Hugging Face Transformers

### Contact and social links

- Email: ammar.nagri1@gmail.com
- Website: 404-ammar-not-found.github.io
- Office address: The University of Manchester
- Phone: +44 7305 975781
- GitHub: 404-ammar-not-found
- LinkedIn: ammarnagri
- X/Twitter: TBD
- Bluesky: TBD
- ORCID: TBD
...
- Website title: Ammar Nagri
- Website subtitle: learning my machine
- Domain: 404-ammar-not-found.github.io
- Theme preference: keep the current al-folio theme and choose the visual accent later
- Accent colour: TBD after image upload and branding pass
- Google Analytics ID: TBD
- Favicon: use the current icon until a custom one is uploaded
- Meta description: Ammar Nagri is a BSc Computer Science and Mathematics undergraduate at The University of Manchester, interested in machine learning, neural networks, and theoretical ML.
- Keywords: machine learning, neural networks, diffusion models, theoretical ML, computer science, mathematics, research engineer, research scientist
- Open Graph image: upload later
- Author name: Ammar Nagri

### CV files

- PDF CV: upload later
- Optional DOCX source: upload later

### Empty sections to fill later

- Publications: none yet
- News/updates: leave empty until there is something worth announcing
- Teaching: optional, leave empty for now
- Talks: leave empty for now
- Portfolio images: upload later

### Blog posts and projects handoff

#### Blog posts

Leave the blog section empty for now. When you are ready to publish something, use this checklist:

1. Create a file in `_posts/` named `YYYY-MM-DD-title.md`.
2. Add front matter with `title`, `date`, `tags`, `categories`, and any image fields you need.
3. Write the post in markdown below the front matter.
4. Upload any images to the site assets folder and reference them with relative paths.
5. Preview the post locally before publishing.

#### Projects

Leave the projects section empty for now and use existing project files as templates when you add one. For each project, capture:
...
5. GitHub repository.
6. Live demo.
7. Images or screenshots.
8. Dates.
9. Team members.
10. Awards or results.

When you are ready, copy one of the existing files in `_projects/`, replace the sample content, and then add the project images later.
